...
// GetSearchDirectory 获取指定目录下的子目录列表
type GetSearchDirectoryData struct {
...
func (w *WoClient) GetSearchDirectory(directoryId string, opts ...RestyOption) (*GetSearchDirectoryData, error) {
	var resp GetSearchDirectoryData
	param := Json{
		"directoryId": directoryId,
		"clientId":    DefaultClientID,
	}
	_, err := w.RequestWoHome(KeyGetSearchDirectory, param, JsonSecret, &resp, opts...)
	if err != nil {
		return nil, err
	}
	return &resp, nil
...
func (w *WoClient) CreateDirectoryPersonal(parentDirectoryId string, directoryName string, opts ...RestyOption) (*CreateDirectoryData, error) {
	return w.CreateDirectory(SpaceTypePersonal, parentDirectoryId, directoryName, "", opts...)
}

func (w *WoClient) CreateDirectoryFamily(parentDirectoryId string, directoryName string, familyId string, opts ...RestyOption) (*CreateDirectoryData, error) {
	return w.CreateDirectory(SpaceTypeFamily, parentDirectoryId, directoryName, familyId, opts...)
}
