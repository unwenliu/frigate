...
// OpenList API methods
const (
	KeyOpenListGetAccessToken = "get_access_token"
	OpenListAPIPath           = "/api/admin/storage"
)
...
// OpenList 相关常量
const (
	// DefaultOpenlistBaseURL OpenList 管理后台默认基础 URL
	DefaultOpenlistBaseURL = "https://openlist.example.com"
	// OpenlistTimeout 默认 OpenList API 请求超时时间
	OpenlistTimeout = 30
)
